...
import com.trailblazers.sentimentalanalysis.dto.responseDto.ResponseParam;
...
public class ResponseCodeUtil {
    ...
    public <T extends BaseResponseUtil> T updateResponseData(T baseResponse, ResponseCodeEnum responseCodeEnum) {
        return updateResponseData(baseResponse, responseCodeEnum, Collections.emptyMap());
    }

    public <T extends BaseResponseUtil> T updateResponseData(T baseResponse, ResponseCodeEnum responseCodeEnum, Map<String, String> params) {
        List<ResponseParam> responseParams = params.entrySet().stream().map(map -> new ResponseParam(map.getKey(), map.getValue())).toList();
    ...
    public String getMessage(ResponseCodeEnum responseCodeEnum, List<ResponseParam> params) {
    ...
    public String buildFullMessage(String template, List<ResponseParam> params) {
    ...
    public <T extends BaseResponseUtil> T updateResponseData(T baseResponse, ResponseCodeEnum responseCode, String description) {
        baseResponse.assignResponseCodeAndDescription(responseCode.getCode(), description);
        return baseResponse;
    }


    public <T> T updateResponseDataReturnObject(BaseResponseUtil response, ResponseCodeEnum responseCodeEnum, T object) {
